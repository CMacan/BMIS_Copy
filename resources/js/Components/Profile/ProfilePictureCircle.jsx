...
export default function ProfilePictureSection({ profile, className }) {
  ...
  return (
    <div className={clsx("bg-white-100 rounded-xl shadow-sm p-4 sm:p-6", className)}>
        ...
        <div className="p-4 sm:p-6 flex flex-col items-center justify-center w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-end gap-2 mt-4 w-full">
            <button
              ...
              className="order-2 sm:order-1 flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-lg text-white hover:bg-gray-50 hover:text-black transition-colors w-full sm:w-auto"
            >
              <X className="w-5 h-5" />
              Cancel
            </button>
