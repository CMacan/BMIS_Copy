...
export default function SeniorCitizenIntakeForm() {
  ...
  const [data, setData] = useState({
    ...
    pwdDocument: null,
    form_id: form_id,
    formType: "SENIOR CITIZEN INTAKE FORM",
  })
  ...
  const nextStep = () => {
    ...
    if (currentStep === 2) {
      if (!data.nature_of_disability) {
        newErrors.nature_of_disability = "Nature of Disability is required."
      }
    }
  ...
  return (
    <UserLayout>
      <Head title="Senior Citizen Intake Form" />
      <div className="px-4 md:px-8 py-6 w-full max-w-5xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-black-800">Senior Citizen Intake Form</h1>
